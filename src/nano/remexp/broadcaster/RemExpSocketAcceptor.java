 ...
 * This class is used to connect to the remote experiments server, accepting inbound
...
public class RemExpSocketAcceptor extends ThreadHandler{
    ...
    /**
     * Only after the port has been added, this thread starts to run and listen on the defined port.
     * 
     * @param port	the port where this thread shall listen for a new remote experiment connection.
     */
    ...
    /**
     * Add a host to the list of hosts which are allowed to connect to the remote experiment broadcaster
     * as remote experiment.
     * 

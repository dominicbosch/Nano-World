...
/**
 * The StreamPipe is the stream broadcaster of the stream data input from the remote experiment
...
public class StreamPipe extends ThreadHandler {
	 ...
	 * input of the pipe continuously.
	 * 
	...
	/**
	 * When a new stream socket is connected it is added to the internal storage. 
	 * 
	 * @param sock	The new stream socket.
	 */
	...
	/**
	 * When a stream socket is closed it is removed from the internal storage. 
	 * 
	 * @param sock	The dying stream socket.
	 */

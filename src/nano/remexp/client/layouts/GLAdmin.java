...
import nano.remexp.client.modules.GMAdminCommands;
...
/**
 * The administrator GUI module with all possible controls.
 * 
 * @author Dominic Bosch
 * @version 1.1 29.08.2012 
 */
public class GLAdmin extends GUILayout{
	public GLAdmin(ClientGUI gui) {
		super(gui);
		panelControls = new JPanel();
		JPanel panelControlsTop = new JPanel();
		JPanel panelControlsRight = new JPanel();
		JPanel panelControlsLeft = new JPanel();
		ClientGUI.setupComponent(panelControls, new Dimension(530, 275), Color.yellow);
		...
		addModule(new GMAdminCommands(), panelControls);
